...
<div class="p-6 space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-3xl font-bold text-gray-100">Nouveau Package</h1>
            <p class="text-gray-400 mt-1">Créer un nouveau forfait d'abonnement</p>
        </div>
    ...
    <div class="bg-dark-100 border border-dark-200 rounded-lg p-6">
        <form action="{{ route('admin.packages.store') }}" method="POST" id="packageForm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-2">
                    ...
                    <select id="type" name="type" required
                        ...
                        <option value="storage" {{ old('type') === 'storage' ? 'selected' : '' }}>Stockage</option>
                        <option value="boost" {{ old('type') === 'boost' ? 'selected' : '' }}>Boost Sponsoring</option>
                ...
                <div class="col-span-2">
                    ...
                    <textarea id="description" name="description" rows="4"
                        ...
                        placeholder="Décrivez les avantages et caractéristiques de ce package">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" id="duration_days" name="duration_days" value="{{ old('duration_days') }}" required min="1"
                ...
                <div id="storage_field" class="hidden">
                    ...
                    <input type="number" id="storage_size_mb" name="storage_size_mb" value="{{ old('storage_size_mb') }}" min="1"
                ...
                <div id="reach_field" class="hidden">
                    ...
                    <input type="number" id="reach_users" name="reach_users" value="{{ old('reach_users') }}" min="1"
            ...
            <!-- Boutons d'action -->
            <div class="flex justify-end gap-4 mt-6 pt-6 border-t border-dark-200">
                <a href="{{ route('admin.packages.index') }}"
