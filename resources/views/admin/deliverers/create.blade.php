        ...
        <div class="bg-dark-100 rounded-xl shadow-lg p-6 mb-6 border border-dark-200">
            ...
            <div class="mb-4">
                ...
                <select name="pricing_type" id="pricing-type" onchange="updatePricingFields()" required
                    ...
                    <option value="volumetric_weight" {{ old('pricing_type') == 'volumetric_weight' ? 'selected' : '' }}>Par tranche de poids réel (kg)</option>
                </select>
                @error('pricing_type')
                    <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-4">
                ...
                <input type="text" name="lead_time" maxlength="60" value="{{ old('lead_time') }}"
