        ...
        <div id="shipping_list" class="text-sm text-gray-300 space-y-1"></div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-dark-100 rounded-xl shadow-lg p-6">
                    ...
                    <div class="mb-4" id="product_weight_field">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        @foreach($product->priceTiers ?? [] as $tier)
            addTierRow({
                ...
                // Encodé en JSON : un palier sans pack (null) cassait le script de la page.
                pack_size: @json($tier->pack_size),
                weight_kg: @json($tier->weight_kg)
            });
        @endforeach
