...
@section('title', 'Modifier une Page Légale')
        ...
        <div class="bg-dark-100 rounded-lg shadow-sm border border-dark-200 p-6">
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-400">URL unique pour accéder à cette page (ex: conditions-generales-utilisation)</p>
                    @error('slug')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        @else
            quill.root.innerHTML = {!! json_encode($legalPage->content) !!};
        @endif
        ...
        // Initialiser le champ hidden au chargement
        updateHiddenField();
    });
</script>
@endpush
